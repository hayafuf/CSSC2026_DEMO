...
(function () {
  ...
  DICT.ja = {
    ...
    "tut.e2t": "🎯 3個そろえて消す",
    "tut.e2": "同じ色を*3個以上*つなげると玉は消える!\n*光っている玉*と同じ色をもう装填してある。ガイド線を光る玉に合わせて、*FIRE* で撃ち込め!",
    "tut.e2pc": "同じ色を*3個以上*つなげると玉は消える!\n*光っている玉*と同じ色をもう装填してある。ガイド線を光る玉に合わせて、*クリック*で撃ち込め!",
    "tut.a2": "*光る玉の真下*から発射!",
    "tut.a2go": "いい位置だ、*撃て!*",
    "tut.e3t": "⇄ 玉の交換",
    "tut.e3": "手玉は「いま」と「つぎ」の2つ。\n色が合わないときは *⇄ ボタン*(大砲タップでも)で交換だ!",
    "tut.e3pc": "手玉は「いま」と「つぎ」の2つ。\n色が合わないときは*右クリック*か *Space* で交換だ!",
    "tut.a3": "⇄ で玉を交換してみよう",
    "tut.a3pc": "右クリックか Space で交換してみよう",
    "tut.e4t": "🌈 万能玉(虹玉)",
    "tut.e4": "どの色にもつながる切り札、それが*虹玉*!\n在庫には限りがあるが、練習で使った分はあとで返すから安心して撃とう。*🌈 ボタン*で装填してみよう!",
    "tut.e4pc": "どの色にもつながる切り札、それが*虹玉*!\n在庫には限りがあるが、練習で使った分はあとで返すから安心して撃とう。*Q キー*で装填してみよう!",
    "tut.a4": "🌈 で虹玉を装填!",
    "tut.a4pc": "Q キーで虹玉を装填!",
    "tut.a4b": "そのまま*発射*!どの色にもつながるぞ!",
    "tut.e5t": "✨ パワーアップアイテム",
    "tut.e5": "金色のアイテムは*パワーアップ*だ!大砲で受け止めてキャッチしよう。\n🪙 コインは集めると*ライフが回復*。🐌 ⚓ 🌬️ は玉の流れを遅くする・止める・押し戻す。💣 🚀 は特殊弾、💎 は「宝玉の力」が選べる。\nためしにコインを1枚落とすぞ。真下に入って受け止めてみよう!",
    "tut.a5": "🪙 コインを*大砲で受け止めよう*!",
    "tut.e6t": "🦑 デバフアイテム",
    "tut.e6": "*紫のアイテム*(🦑 ⏳)はデバフだ!取ってしまうと墨で視界がにごったり、弾が遅くなったりする。大砲で受け止めず、*横に避けて*やり過ごそう。\nためしに1つ落とすぞ。避けてみよう!",
    "tut.a6": "☠ 紫のデバフを*左右に避けよう*!",
    "tut.e7t": "💀 障害物: 髑髏玉",
    "tut.e7": "*髑髏マークの玉*は、光って警告音を鳴らしたあと、大砲めがけて妖弾を撃ってくる!当たると一時停止や操作反転のデバフを受ける。\n*横に動いて避ける*か、*自分の玉をぶつけて迎撃*しよう。髑髏玉そのものを消せばボーナス報酬だ。\nいまから1体目覚めさせるぞ。備えろ!",
    "tut.a7": "💀 妖弾を*避けるか、玉をぶつけて迎撃*!",
    "tut.e8t": "🏴‍☠️ 勝利と敗北",
    "tut.e8": "玉が奥の*樽*に飛び込むと*1ミス*!\n画面上の*ゲージ*が尽きるまで生き延びて、残った玉を全部消せば*勝利*だ。それでは、良い航海を!",
