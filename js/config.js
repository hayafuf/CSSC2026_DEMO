...
(function () {
  ...
  PP.STAGE_SPEED = {
    hard: {
      5: { entry: 815, hole: 21.0, curve: 2.0 }
    },
    hardcore: {
      5: { entry: 818, hole: 21.5, curve: 2.0 }
    }
  };
  ...
  // 全回復はカード「七海の虹玉」取得時(最大+1のおまけ付き)とラン開始時のみ。
  // ほかに、ゲームオーバーからのコンティニューで1個だけ補充される(input.js)。
  PP.WILD = {
  ...
  PP.game = {
    ...
    wildMax: PP.WILD.baseMax,     // 【新】虹玉の最大ストック(「七海の虹玉」で増える)
